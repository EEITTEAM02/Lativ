				...
				<div class="jumbotron">
					...
					<div class="row">
						...
						<div class="col-sm-5">
							...
							<a title="Pima 棉V領T恤" href="productImages/92"
								data-fancybox="gallery1" id="bigImg"> <img
								src="productImages/92" class="img-rounded" width="100%"
								id="smallImg" />
							</a>
...
//                                  console.log($('#spanPwd').text());
		...
		<div class="row">
			<div class="col-md-12">
				<img src="modelImages1/92" style="width: 100%">
			</div>
		</div>
		<br></br>
		<div class="row">
			<div class="col-md-12">
				<img src="modelImages2/92" style="width: 100%">
			</div>
		</div>
		<br></br>
		<div class="row">
			<div class="col-md-12">
				<img src="modelImages3/92" style="width: 100%">
			</div>
		</div>
		<br></br>
		<div class="row">
			<div class="col-md-12">
				<img src="modelImages4/92" style="width: 100%">
			</div>
		</div>
		<br></br>
