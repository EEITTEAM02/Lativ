			...
			<div class="col-md-12">
				<div class="jumbotron">
					...
					<div class="row">
						...
						<div class="col-sm-5">					
							<a title="Pima 棉V領T恤" href="productImages/50"
								data-fancybox="gallery1" id="bigImg"> <img
								src="productImages/50" class="img-rounded" width="100%"
								id="smallImg" />
							</a>
...
//                                  console.log($('#spanPwd').text());
		...
		<div class="row">
			<div class="col-md-12">
				<img src="modelImages1/50" style="width: 100%">
			</div>
		</div>
		<br></br>
		<div class="row">
			<div class="col-md-12">
				<img src="modelImages2/50" style="width: 100%">
			</div>
		</div>
		<br></br>
		<div class="row">
			<div class="col-md-12">
				<img src="modelImages3/50" style="width: 100%">
			</div>
		</div>
		<br></br>
		<div class="row">
			<div class="col-md-12">
				<img src="modelImages4/50" style="width: 100%">
			</div>
		</div>
		<br></br>
