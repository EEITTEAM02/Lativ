			...
			<div class="col-md-12">
				<div class="jumbotron">
					...
					<div class="row">
						...
						<div class="col-sm-5">					
							<a title="Pima 棉V領T恤" href="productImages/74"
								data-fancybox="gallery1" id="bigImg"> <img
								src="productImages/74" class="img-rounded" width="100%"
								id="smallImg" />
							</a>
...
//                                  console.log($('#spanPwd').text());
		...
		<div class="row">
			<div class="col-md-12">
				<img src="modelImages1/74" style="width: 100%">
			</div>
		</div>
		<br></br>
		<div class="row">
			<div class="col-md-12">
				<img src="modelImages2/74" style="width: 100%">
			</div>
		</div>
		<br></br>
		<div class="row">
			<div class="col-md-12">
				<img src="modelImages3/74" style="width: 100%">
			</div>
		</div>
		<br></br>
		<div class="row">
			<div class="col-md-12">
				<img src="modelImages4/74" style="width: 100%">
			</div>
		</div>
		<br></br>
                     ...
                     var priceD = datas.unitPriceDiscounted;
       		        ...
       		        div213.html(small);
          		        ...
          		        for (var i=0;i<datas.l2.length;i++){
          		            img = $('<img></img>').attr({"src":"colorImages/"+datas.l2[i],"id":i}).addClass("colorImg").mouseover(function(event){
          		            	span2.empty();
          		            	span1.empty();
