				...
				<div class="jumbotron">
					...
					<div class="row">
						...
						<div class="col-sm-5">
							...
							<a title="Pima 棉V領T恤" href="productImages/47"
								data-fancybox="gallery1" id="bigImg"> <img
								src="productImages/47" class="img-rounded" width="100%"
								id="smallImg" />
							</a>
...
<!-- 									<img id="idimg1" src="/WebsiteV1.3/images/star.gif" -->
...
//                                  console.log($('#spanPwd').text());
		...
		<div class="row">
			<div class="col-md-12">
				<img src="modelImages1/47" style="width: 100%">
			</div>
		</div>
		<br></br>
		<div class="row">
			<div class="col-md-12">
				<img src="modelImages2/47" style="width: 100%">
			</div>
		</div>
		<br></br>
		<div class="row">
			<div class="col-md-12">
				<img src="modelImages3/47" style="width: 100%">
			</div>
		</div>
		<br></br>
		<div class="row">
			<div class="col-md-12">
				<img src="modelImages4/47" style="width: 100%">
			</div>
		</div>
		<br></br>
