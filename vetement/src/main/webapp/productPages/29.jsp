			...
			<div class="col-md-12">
				<div class="jumbotron">
					...
					<div class="row">
						...
						<div class="col-sm-5">					
							<a title="Pima 棉V領T恤" href="productImages/29"
								data-fancybox="gallery1" id="bigImg"> <img
								src="productImages/29" class="img-rounded" width="100%"
								id="smallImg" />
							</a>
...
//                                  console.log($('#spanPwd').text());
		...
		<div class="row">
			<div class="col-md-12">
				<img src="modelImages1/29" style="width: 100%">
			</div>
		</div>
		<br></br>
		<div class="row">
			<div class="col-md-12">
				<img src="modelImages2/29" style="width: 100%">
			</div>
		</div>
		<br></br>
		<div class="row">
			<div class="col-md-12">
				<img src="modelImages3/29" style="width: 100%">
			</div>
		</div>
		<br></br>
		<div class="row">
			<div class="col-md-12">
				<img src="modelImages4/29" style="width: 100%">
			</div>
		</div>
		<br></br>
