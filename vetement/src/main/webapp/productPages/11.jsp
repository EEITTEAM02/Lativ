			...
			<div class="col-md-12">
				<div class="jumbotron">
					...
					<div class="row">
						...
						<div class="col-sm-5">
							<!-- 						var aTag = $('<a></a>').attr({'title':product.name,'href':"productImages/parrot.jpg"+product.pno,'data-fancybox':'gallery'+no}); -->
							<a title="Pima 棉V領T恤" href="productImages/11"
								data-fancybox="gallery1" id="bigImg"> <img
								src="productImages/11" class="img-rounded" width="100%"
								id="smallImg" />
							</a>
...
<!-- 									<img id="idimg1" src=ctx+"/images/star.gif" -->
<!-- 										style="width: 20px; height: 20px;" /> <img id="idimg2" -->
<!-- 										src=ctx+"/images/star.gif" -->
...
<!-- 										src="/WebsiteV1.3/images/star.gif" -->
...
//                                  console.log($('#spanPwd').text());
		...
		<div class="row">
			<div class="col-md-12">
				<img src="modelImages1/11" style="width: 100%">
			</div>
		</div>
		<br></br>
		<div class="row">
			<div class="col-md-12">
				<img src="modelImages2/11" style="width: 100%">
			</div>
		</div>
		<br></br>
		<div class="row">
			<div class="col-md-12">
				<img src="modelImages3/11" style="width: 100%">
			</div>
		</div>
		<br></br>
		<div class="row">
			<div class="col-md-12">
				<img src="modelImages4/11" style="width: 100%">
			</div>
		</div>
		<br></br>
